...
`),n("span",{class:"line"},[n("span",null,"render() {")]),l(`
`),n("span",{class:"line"},[n("span",null,"  // React 并*没有*创建一个新的 div。")]),l(`
`),n("span",{class:"line"},[n("span",null,"  // 它只是把子元素渲染到 `domNode` 中。")]),l(`
...
`),n("span",{class:"line"},[n("span",null,"}")])])])]),n("p",null,[l("一个 portal 的典型用例是当父组件有 overflow: hidden 或 z-index 样式时，但你需要子组件能够在视觉上“跳出”其容器。例如，对话框、悬浮卡以及提示框： 注意: 当在使用 portal 时, 记住"),n("a",{href:"https://react.docschina.org/docs/accessibility.html#programmatically-managing-focus",target:"_blank",rel:"noreferrer"},"管理键盘焦点"),l("就变得尤为重要。 对于模态对话框，通过遵循 "),n("a",{href:"https://www.w3.org/TR/wai-aria-practices-1.1/#dialog_modal",target:"_blank",rel:"noreferrer"},"WAI-ARIA"),l(" 模态开发实践，来确保每个人都能够运用它。")]),n("p",null,[n("strong",null,"通过"),l(),n("strong",null,"Portal"),l(),n("strong",null,"进行事件冒泡"),l(" 尽管 portal 可以被放置在 DOM 树中的任何地方，但在任何其他方面，其行为和普通的 React 子节点行为一致。由于 portal 仍存在于 "),n("em",null,"React"),l(),n("em",null,"树"),l("， 且与 "),n("em",null,"DOM"),l(),n("em",null,"树"),l(" 中的位置无关，那么无论其子节点是否是 portal，像 context 这样的功能特性都是不变的。 这包含事件冒泡。一个从 portal 内部触发的事件会一直冒泡至包含 "),n("em",null,"React"),l(" _树_的祖先，即便这些元素并不是 "),n("em",null,"DOM"),l(),n("em",null,"树"),l(' 中的祖先。假设存在如下 HTML 结构： <html> <body> <div id="app-root"></div> <div id="modal-root"></div> </body> </html>')]),n("div",{class:"language- vp-adaptive-theme"},[n("button",{title:"Copy Code",class:"copy"}),n("span",{class:"lang"}),n("pre",{class:"shiki shiki-themes github-light github-dark vp-code",tabindex:"0","v-pre":""},[n("code",null,[n("span",{class:"line"},[n("span",null,"在 #app-root 里的 Parent 组件能够捕获到未被捕获的从兄弟节点 #modal-root 冒泡上来的事件。")]),l(`
...
`),n("span",{class:"line"},[n("span",null,"      clicks: 0")]),l(`
`),n("span",{class:"line"},[n("span",null,"    };")]),l(`
...
`),n("span",{class:"line"},[n("span",null,"    this.setState(state => ({")]),l(`
`),n("span",{class:"line"},[n("span",null,"      clicks: state.clicks + 1")]),l(`
`),n("span",{class:"line"},[n("span",null,"    }));")]),l(`
`),n("span",{class:"line"},[n("span",null,"  }")]),l(`
`),n("span",{class:"line"},[n("span",null,"  render() {")]),l(`
`),n("span",{class:"line"},[n("span",null,"    return (")]),l(`
`),n("span",{class:"line"},[n("span",null,"      <div onClick={this.handleClick}>")]),l(`
`),n("span",{class:"line"},[n("span",null,"        <p>点击数: {this.state.clicks}</p>")]),l(`
