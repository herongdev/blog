import{_ as l,o as e,c as p,j as n,a as s}from"./chunks/framework.DJo0M80U.js";const _=JSON.parse('{"title":"类变量和实例变量（成员变量）","description":"","frontmatter":{"title":"类变量和实例变量（成员变量）","date":"2026-07-03T00:00:00.000Z","categories":["Java 快速入门"],"tags":["Java","面向对象","OneNote"],"lastUpdated":false},"headers":[],"relativePath":"posts/java快速入门/第二部分：面向对象/01-类与对象/类和对象/类变量和实例变量（成员变量）.md","filePath":"posts/java快速入门/第二部分：面向对象/01-类与对象/类和对象/类变量和实例变量（成员变量）.md"}'),t={name:"posts/java快速入门/第二部分：面向对象/01-类与对象/类和对象/类变量和实例变量（成员变量）.md"};function c(i,a,o,r,u,m){return e(),p("div",null,[...a[0]||(a[0]=[n("div",null,[n("div",{class:"language- vp-adaptive-theme"},[n("button",{title:"Copy Code",class:"copy"}),n("span",{class:"lang"}),n("pre",{class:"shiki shiki-themes github-light github-dark vp-code",tabindex:"0","v-pre":""},[n("code",null,[n("span",{class:"line"},[n("span",null,"获取值：")]),s(`
`),n("span",{class:"line"},[n("span",null,"要获取实例变量的值，可以使用句点表示法。实例变量和类变量由两个部分组成：")]),s(`
...
`),n("span",{class:"line"},[n("span")]),s(`
`),n("span",{class:"line"},[n("span",null,"类FamilyMember的每个实例都有自己的name和age值；但对所有FamilMember实例来说，类变量surname的值都相同：Mendoza。修改surname的值将影响所有FamilyMember实例。")]),s(`
`),n("span",{class:"line"},[n("span")]),s(`
...
`),n("span",{class:"line"},[n("span")]),s(`
`),n("span",{class:"line"},[n("span",null,"由于可以使用对象来修改类变量的值，因此容易地类变量及其值从何而来感到困惑。所以为了避免这种情况，应使用类名来引用类变量，这样可以清楚地指出了引用的是类变量，出现奇怪结果时，调试起来也更容易。")]),s(`
`),n("span",{class:"line"},[n("span")]),s(`
`),n("span",{class:"line"},[n("span",null,"**调用方法**")]),s(`
`),n("span",{class:"line"},[n("span",null,"调用对象的方法时也使用句点表示法。被调用的对象位于句点左边，方法名及其参数位于句点右边，如：")]),s(`
`),n("span",{class:"line"},[n("span",null,"customer.addToCart(itemNumber,price,quantity);")]),s(`
`),n("span",{class:"line"},[n("span",null,"调用方法时，方法名后面都必须有圆括号，即使该方法没有任何参数，如下所示：")]),s(`
`),n("span",{class:"line"},[n("span",null,"customer.cancelOrder();")])])])])],-1)])])}const g=l(t,[["render",c]]);export{_ as __pageData,g as default};
