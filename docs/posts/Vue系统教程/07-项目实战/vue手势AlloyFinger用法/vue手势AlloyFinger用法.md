...
tags:
  ...
  - "OneNote"
  - "项目实战"
description: "下载： 滑动的有效区域 亲测有效 其他手勢方法： 来自。"
sidebarWeight: 57
lastUpdated: false
feed: false
source: onenote
sourceNote: "OneNote/f-vue/实战/vue手势AlloyFinger用法/vue手势AlloyFinger用法.md"
---
::: v-pre

# vue手势AlloyFinger用法

> 本节目标：理解“vue手势AlloyFinger用法”的核心思路，并能把它用于实际开发或面试表达。
下载：
...
```
 <https://www.jianshu.com/p/29e9806a3efe>
```
