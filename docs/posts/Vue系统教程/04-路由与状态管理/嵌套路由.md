...
tags:
  ...
  - "OneNote"
  - "路由与状态管理"
description: "一些应用程序的 UI 由多层嵌套的组件组成。在这种情况下，URL 的片段通常对应于特定的嵌套组件结构，例如： /user/johnny/profile /user/johnny/posts 通过 Vue Router，你可以使用嵌套路由配置来表达这种关系。 接着上节创建的 app。"
sidebarWeight: 46
lastUpdated: false
feed: false
source: onenote
sourceNote: "OneNote/f-vue/vueRouter/嵌套路由.md"
---
::: v-pre
