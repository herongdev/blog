---
title: "神奇 这款 Vue 后台框架居然不用手动配置路由"
date: 2026-08-11
categories:
  - "Vue 系统教程"
tags:
  ...
  - "OneNote"
  - "路由与状态管理"
description: "Alinmei 于 2022 03 04 17:26:09 发布 2621 收藏 6 分类专栏： 前端技术 文章标签： java 前端 版权 前端技术 专栏收录该内容 6 篇文章0 订阅 订阅专栏 前言 做 Vue 开发脱离不了路由，尤其是中大型项目，页面多且杂，在配置路由的时候。"
sidebarWeight: 53
lastUpdated: false
feed: false
source: onenote
sourceNote: "OneNote/f-vue/vueRouter/神奇 这款 Vue 后台框架居然不用手动配置路由.md"
---
::: v-pre

# 神奇 这款 Vue 后台框架居然不用手动配置路由

> 本节目标：理解“神奇 这款 Vue 后台框架居然不用手动配置路由”的核心思路，并能把它用于实际开发或面试表达。
Alinmei

于 2022-03-04 17:26:09 发布

2621
收藏 6
分类专栏： 前端技术 文章标签： java 前端
版权
...
import Pages from 'vite-plugin-pages'   export default \{
plugins: [
Pages(\{
...
————————————————
版权声明：本文为CSDN博主「Alinmei」的原创文章，遵循CC 4.0 BY-SA版权协议，转载请附上原文出处链接及本声明。
原文链接：https://blog.csdn.net/Alinmei/article/details/123281288
