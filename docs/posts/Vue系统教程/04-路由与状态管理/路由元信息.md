...
tags:
  ...
  - "OneNote"
  - "路由与状态管理"
description: "有时，你可能希望将任意信息附加到路由上，如过渡名称、谁可以访问路由等。这些事情可以通过接收属性对象的meta属性来实现，并且它可以在路由地址和导航守卫上都被访问到。定义路由的时候你可以这样配置 meta 字段： const routes [ \\{ path: '/posts',。"
sidebarWeight: 58
lastUpdated: false
feed: false
source: onenote
sourceNote: "OneNote/f-vue/vueRouter/路由元信息.md"
---
::: v-pre

# 路由元信息

> 本节目标：理解“路由元信息”的核心思路，并能把它用于实际开发或面试表达。
