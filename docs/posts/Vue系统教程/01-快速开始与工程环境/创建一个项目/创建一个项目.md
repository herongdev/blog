...
tags:
  ...
  - "OneNote"
  - "快速开始与工程环境"
description: "vue create 运行以下命令来创建一个新项目： vue create hello world 警告 如果你在 Windows 上通过 minTTY 使用 Git Bash，交互提示符并不工作。你必须通过 winpty vue.cmd create hello world 启。"
sidebarWeight: 14
lastUpdated: false
feed: false
source: onenote
sourceNote: "OneNote/f-vue/vue-cli/创建一个项目/创建一个项目.md"
---
::: v-pre

# 创建一个项目

> 本节目标：理解“创建一个项目”的核心思路，并能把它用于实际开发或面试表达。
...
npminstall-g @vue/cli-init# `vue init` 的运行效果将会跟 `vue-cli@2.x` 相同vue init webpack my-project
 \> 来自 \<[https://cli.vuejs.org/zh/guide/creating-a-project.html#%E4%BD%BF%E7%94%A8%E5%9B%BE%E5%BD%A2%E5%8C%96%E7%95%8C%E9%9D%A2](https://cli.vuejs.org/zh/guide/creating-a-project.html#%E4%BD%BF%E7%94%A8%E5%9B%BE%E5%BD%A2%E5%8C%96%E7%95%8C%E9%9D%A2)\>
Vue-cli手动选择要素安装
