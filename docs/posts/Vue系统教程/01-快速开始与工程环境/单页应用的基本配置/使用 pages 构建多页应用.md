...
tags:
  ...
  - "OneNote"
  - "快速开始与工程环境"
description: "对于项目复杂度过高或者页面模块之间差异化较大的项目，我们可以选择构建多页应用来实现。 概念 首先我们可以把多页应用理解为由多个单页构成的应用，而何谓多个单页呢？其实你可以把一个单页看成是一个 html 文件，那么多个单页便是多个 html 文件，多页应用便是由多个 html 组成。"
sidebarWeight: 45
lastUpdated: false
feed: false
source: onenote
sourceNote: "OneNote/f-vue/安装配置/单页应用的基本配置/使用 pages 构建多页应用.md"
---
::: v-pre

# 使用 pages 构建多页应用

> 本节目标：理解“使用 pages 构建多页应用”的核心思路，并能把它用于实际开发或面试表达。
...
==/* webpack== ==配置文件== ==*/======**const** ==HtmlWebpackPlugin === ==require====(===='html-webpack-plugin'====)== ==//== ==安装并引用插件==
==module====.exports = {======    ==...======    ====    ==plugins: [======        **new** ==HtmlWebpackPlugin({======            ==title:== =='My Page'====,== ==//== ==生成== ==html== ==中的== ==title======            ==filename:== =='demo.html'====,== ==//== ==生成== ==html== ==的文件名======            ==template:== =='xxx/xxx/demo.html'====,== ==//== ==模板路径======            ==chunks: [===='manifest'====,== =='vendor'====,== =='demo'====],== ==//== ==所要包含的模块======            ==inject:== ==true====,== ==//== ==是否注入资源======        ==})======    ==]======    ====    ==...========}==
...
```
 <https://juejin.im/book/5b23a5aef265da59716fda09/section/5b4dea65f265da0f4559fbc3>
```
