...
tags:
  ...
  - "OneNote"
  - "工程化、质量与性能"
description: "SSR 完全指南 在 2.3 发布后我们发布了一份完整的构建 Vue 服务端渲染应用的指南。这份指南非常深入，适合已经熟悉 Vue 、 webpack 和 Node.js 开发的开发者阅读。请移步 ssr.vuejs.org 。 Nuxt.js 从头搭建一个服务端渲染的应用是相当。"
sidebarWeight: 65
lastUpdated: false
feed: false
source: onenote
sourceNote: "OneNote/f-vue/规模化/服务端渲染.md"
---
::: v-pre

# 服务端渲染

> 本节目标：理解“服务端渲染”的核心思路，并能把它用于实际开发或面试表达。
==SSR== ==完全指南==
