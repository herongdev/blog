...
![ObjectOutputStream ObjectInputStream](Exported%20image%2020260702223829-0.png)
...
public transient int age; // transient
瞬态修饰成员`,`不会被序列化
...
public class DeserializeDemo {public static void main(String [] args) {
Employee e = null;
try {
//
创建反序列化流
...
接口给需要序列化的类，提供了一个序列版本号。 `serialVersionUID` 该版本号的目的在于验证序列化的对象和对应类是否版本匹配。
