---
title: "78. Crash Analysis and Core Dumps"
date: "2026-07-04"
categories:
  - "C 教程"
tags:
...
description: "The Little Book of C — 78. Crash Analysis and Core Dumps"
...
---
[中文版本](/posts/c教程/zh-CN/08-调试测试与 profiling/078-Crash Analysis and Core Dumps)
...
Now when your program crashes, a file named`core` or`core. ` will appear.
...
Enable dumps:`ulimit -c unlimited`
...
- `frame ` to inspect each stack frame
