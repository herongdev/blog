...
tags:
  ...
  - "OneNote"
  - "语法、变量与数据"
description: "一、Number.MAX SAFE INTEGER和Number.MIN SAFE INTEGER 两个常量，用来表示安全整数个范围的上下限。 Number.MAX SAFE INTEGER Math.pow(2, 53) 1// trueNumber.MAX SAFE INTE。"
sidebarWeight: 45
lastUpdated: false
feed: false
source: onenote
sourceNote: "OneNote/b-原生js/基本数据类型-数字/Number静态属性.md"
---
::: v-pre

# Number静态属性

> 本节目标：理解“Number静态属性”的核心思路，并能把它用于实际开发或面试表达。
一、Number.MAX_SAFE_INTEGER和Number.MIN_SAFE_INTEGER
两个常量，用来表示安全整数个范围的上下限。
...
0.1 + 0.2 === 0.3 // falsewithinErrorMargin(0.1 + 0.2, 0.3) // true
1.1 + 1.3 === 2.4 // falsewithinErrorMargin(1.1 + 1.3, 2.4) // true
