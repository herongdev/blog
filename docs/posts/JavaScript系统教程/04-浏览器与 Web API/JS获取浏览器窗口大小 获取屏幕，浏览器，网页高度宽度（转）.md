---
title: "JS获取浏览器窗口大小 获取屏幕，浏览器，网页高度宽度（转）"
date: 2026-08-11
categories:
  - "JavaScript 系统教程"
tags:
  ...
  - "OneNote"
  - "浏览器与 Web API"
description: "2019 03 05阅读 1K0 网页可见区域宽：document.body.clientWidth 网页可见区域高：document.body.clientHeight 网页可见区域宽：document.body.offsetWidth (包括边线的宽) 网页可见区域高：doc。"
sidebarWeight: 35
lastUpdated: false
feed: false
source: onenote
sourceNote: "OneNote/b-原生js/DOM/JS获取浏览器窗口大小 获取屏幕，浏览器，网页高度宽度（转）.md"
---
::: v-pre

# JS获取浏览器窗口大小 获取屏幕，浏览器，网页高度宽度（转）

> 本节目标：理解“JS获取浏览器窗口大小 获取屏幕，浏览器，网页高度宽度（转）”的核心思路，并能把它用于实际开发或面试表达。
2019-03-05阅读 1K0
