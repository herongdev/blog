...
feed: false
source: onenote
sourceNote: "OneNote/b-原生js/DOM/event.stopImmediatePropagation.md"
---
::: v-pre
...
```
 **浏览器兼容性**
 \> 来自 \<[https://developer.mozilla.org/zh-CN/docs/Web/API/Event/stopImmediatePropagation](https://developer.mozilla.org/zh-CN/docs/Web/API/Event/stopImmediatePropagation)\>
