...
tags:
  ...
  - "OneNote"
  - "对象、数组与函数"
description: "原生构造函数是指语言内置的构造函数，通常用来生成数据结构。ECMAScript 的原生构造函数大致有下面这些。"
sidebarWeight: 178
lastUpdated: false
feed: false
source: onenote
sourceNote: "OneNote/b-原生js/面向对象程序设计/Class 的继承/原生构造函数的继承.md"
---
::: v-pre

# 原生构造函数的继承

> 本节目标：理解“原生构造函数的继承”的核心思路，并能把它用于实际开发或面试表达。
...
var arr = new MyArray();arr[0] = 12;arr.length // 1
...
x.push(1);x.push(2);x // [1, 2]x.history // [[]]
x.commit();x.history // [[], [1, 2]]
x.push(3);x // [1, 2, 3]x.history // [[], [1, 2]]
x.revert();x // [1, 2]
...
var myerror = new MyError('ll');myerror.message // "ll"myerror instanceof Error // truemyerror.name // "MyError"myerror.stack// Error//     at MyError.ExtendableError//     ...
