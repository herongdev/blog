...
tags:
  ...
  - "OneNote"
  - "面试复习"
description: "一、组件是什么 回顾以前对组件的定义： 组件就是把图形、非图形的各种逻辑均抽象为一个统一的概念（组件）来实现开发的模式，在 Vue 中每一个 .vue 文件都可以视为一个组件 组件的优势 降低整个系统的耦合度，在保持接口不变的情况下，我们可以替换不同的组件快速完成需求，例如输入框。"
sidebarWeight: 30
lastUpdated: false
feed: false
source: onenote
sourceNote: "OneNote/f-vue/面试/概念/【中高】Vue中组件和插件有什么区别？.md"
---
::: v-pre

# 【中高】Vue中组件和插件有什么区别？

> 本节目标：理解“【中高】Vue中组件和插件有什么区别？”的核心思路，并能把它用于实际开发或面试表达。
==一、组件是什么==
==回顾以前对组件的定义：==
...
constcomponent1 ={...}// 定义一个组件exportdefault{components:{component1   // 局部注册}}
```
...
```
 <https://vue3js.cn/interview/vue/components_plugin.html#%E4%B8%89%E3%80%81%E4%B8%A4%E8%80%85%E7%9A%84%E5%8C%BA%E5%88%AB>
```
