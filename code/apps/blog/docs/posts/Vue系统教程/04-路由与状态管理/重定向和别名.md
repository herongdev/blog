...
tags:
  ...
  - "OneNote"
  - "路由与状态管理"
description: "重定向 重定向也是通过 routes 配置来完成，下面例子是从 /home 重定向到 /： const routes [\\{ path: '/home', redirect: '/' \\}] 重定向的目标也可以是一个命名的路由： const routes [\\{ path: '/。"
sidebarWeight: 65
lastUpdated: false
feed: false
source: onenote
sourceNote: "OneNote/f-vue/vueRouter/重定向和别名.md"
---
::: v-pre

# 重定向和别名

> 本节目标：理解“重定向和别名”的核心思路，并能把它用于实际开发或面试表达。
**重定向**
