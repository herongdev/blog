...
feed: false
source: onenote
sourceNote: "OneNote/f-vue/实战/vue手势AlloyFinger用法/alloyFinger使用源码.md"
---
::: v-pre

# alloyFinger使用源码

> 本节目标：理解“alloyFinger使用源码”的核心思路，并能把它用于实际开发或面试表达。
```
<!DOCTYPE html>
<html>
<head lang="en">
...
<body>
    ...
    <div class="footer">
        <div> <a class="btn" href="http://alloyteam.github.io/AlloyFinger/example/picture/">
```
