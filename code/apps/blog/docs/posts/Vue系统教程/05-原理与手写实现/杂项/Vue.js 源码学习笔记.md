...
tags:
  ...
  - "OneNote"
  - "原理与手写实现"
description: "最近饶有兴致的又把最新版 Vue.js 的源码学习了一下，觉得真心不错，个人觉得 Vue.js 的代码非常之优雅而且精辟，作者本身可能无 (bu) 意 (xie) 提及这些。那么，就让我来吧：） 程序结构梳理 Vue.js 是一个非常典型的 MVVM 的程序结构，整个程序从最上层。"
sidebarWeight: 25
lastUpdated: false
feed: false
source: onenote
sourceNote: "OneNote/f-vue/原理/杂项/Vue.js 源码学习笔记.md"
---
::: v-pre

# Vue.js 源码学习笔记

> 本节目标：理解“Vue.js 源码学习笔记”的核心思路，并能把它用于实际开发或面试表达。
...
这里面大部分内容可以直接跟 Vue.js 的[官方](https://vuejs.org/api/) API 参考文档对应起来，但文档里面没有且值得一提的是构造函数的设计，下面是我摘出的构造函数最核心的工作内容。
...
实际上，我在看代码的过程中[顺手提交了这个](https://github.com/yyx990803/vue/issues/1063) bug，作者眼明手快，当天就进行了修复，现在最新的代码里已经不是这个样子了：
...
总之，分享一些自己的收获和代码的细节，希望可以帮助大家开阔思路，提供灵感。
 \> 来自 \<[https://jiongks.name/blog/vue-code-review/](https://jiongks.name/blog/vue-code-review/)\>
