---
title: "import { createDOM, findDOM, compareTwoVdom } from '.-react-dom';"
date: 2026-08-11
categories:
  - "React 系统教程"
tags:
...
feed: false
source: onenote
sourceNote: "OneNote/f-vue/实现/import { createDOM, findDOM, compareTwoVdom } from '.-react-dom';.md"
---
::: v-pre

# import { createDOM, findDOM, compareTwoVdom } from '.-react-dom';

> 本节目标：理解“import { createDOM, findDOM, compareTwoVdom } from '.-react-dom';”的核心思路，并能把它用于实际开发或面试表达。
```
import { createDOM, findDOM, compareTwoVdom } from './react-dom';
//
```
