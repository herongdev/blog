...
tags:
  ...
  - "OneNote"
  - "面试与手写"
description: "15. AJAX是 Asynchronous JavaScript and XML 的缩写，指的是通过 JavaScript 的 异步通信，从服务器获取 XML 文档从中提取数据，再更新当前网页的对应部分，而不用刷新整个网页。 创建AJAX请求的步骤： 在这个对象上 使用 ope。"
sidebarWeight: 10
lastUpdated: false
feed: false
source: onenote
sourceNote: "OneNote/b-原生js/面试/手写/js实现AJAX请求.md"
---
::: v-pre

# js实现AJAX请求

> 本节目标：理解“js实现AJAX请求”的核心思路，并能把它用于实际开发或面试表达。
**15.**
