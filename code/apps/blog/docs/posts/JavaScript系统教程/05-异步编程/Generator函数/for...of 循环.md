...
tags:
  ...
  - "OneNote"
  - "异步编程"
description: "围绕“for...of 循环”整理的概念、示例与实践笔记。"
sidebarWeight: 15
lastUpdated: false
feed: false
source: onenote
sourceNote: "OneNote/b-原生js/11-异步编程/Generator函数/for...of 循环.md"
---
::: v-pre
...
// 扩展运算符[...numbers()] // [1, 2]
// Array.from 方法Array.from(numbers()) // [1, 2]
// 解构赋值let [x, y] = numbers();x // 1y // 2
// for...of 循环for (let n of numbers()) {  console.log(n)}// 1// 2
```
