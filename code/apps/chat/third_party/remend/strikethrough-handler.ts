// Local change (2026-09-03): default missing tilde counts to 0 for strict TypeScript checking.
// Original implementation: vercel/streamdown, remend@1.3.1. See LICENSE and manifest.json.
import {
  isInsideCodeBlock,
